...
#define GETMAXHEALTH_IS_VIRTUAL
	...
	SOURCE_ENGINE != SE_BLADE && SOURCE_ENGINE != SE_MCV && SOURCE_ENGINE != SE_CSSO
...
#if SOURCE_ENGINE == SE_HL2DM || SOURCE_ENGINE == SE_DODS || SOURCE_ENGINE == SE_CSS || SOURCE_ENGINE == SE_TF2 \
	|| SOURCE_ENGINE == SE_BMS || SOURCE_ENGINE == SE_SDK2013 || SOURCE_ENGINE == SE_PVKII || SOURCE_ENGINE == SE_CSSO
